...
def main():
    ...
    def press(button):
        ...
        if button == "Add a Transaction":
            ...
            db.readTable(dbloc,main)
        elif button == "Save":
            print("Save")
            dbloc = main.saveBox("Save Current",fileExt=".sqlite",fileTypes=[('database','*.sqlite')],asFile=False)
            db.newSave(dbloc,main)
        elif button == "Quit":
            main.stop()
        ...
        ### ADD FUNCTIONS ###
            ...
            db.insert(coin,amount,dbloc,main)
        ...
        ### START OF EDIT FUNCTIONS ###
            ...
            #Output for testing
            db.edit(coin,amount,dbloc,main)
            #Return to main form
