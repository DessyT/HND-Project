...
def main():
    ...
    def press(button):
        ...
        ### ADD FUNCTIONS ###
            ...
            #Get type of coin
            coin_type = ""
            coin_type = main.getOptionBox("Coins")
            
            insert(coin_type,coin_amount,dbloc)
            
            #Combine to string and display
            output = ""
            output = "You have bought " + str(coin_amount) + " " + coin_type
            print(output)
        ...
        ### START OF EDIT FUNCTIONS ###
            ...
            #Get new no coins
            coin_amount = 0
            coin_amount = main.getEntry("edit_no_coin")
            #Get coin type
            coin_type = ""
            coin_type = main.getOptionBox("Edit Coins")
            #Output for testing
            print(str(coin_amount) + coin_type)
            #Return to main form
        ...
        #Open file save form
            ...
            print("New")
            dbloc = main.saveBox("Init_New",fileExt=".sqlite",fileTypes=[('database','*.sqlite')],asFile=True,parent="Init_Form")
            main.hideSubWindow("Init_Form")
            main.show()
        #End execution
        elif button == "Exit":
    ...
    main.addLabelOptionBox("Edit Coins",["Bitcoin","Litecoin","Vertcoin"],1)
    main.addNumericEntry("edit_no_coin")
...
def createTable(dbloc):
    ...
    c.execute("insert into coins (coin,price,holdings,holdings_value) values('Bitcoin','0','5','0');")
...
"""def dspHoldings(dbloc):
    ...
    main.addListBox("Holdings", ["BTC: £500", "LTC: £200", "VTC: £100"],1,1,2,4)
    main.updateListBox("Holdings", ["""


def insert(coin,amount,dbloc):
    #Add coin to table record
    db = sqlite3.connect(dbloc)
    c = db.cursor()
