"""
Crypto Currency Tracking Software
Created by Andrew Trail
andrewtrail@googlemail.com
v1
"""
...
#Main form
def main():
    main = gui("Crypto Tracker", "700x300", showIcon=False)
    ...
    def press(button):
        ...
        #Open a different folio dialog
            ...
            #If open dialog is closed assign dbloc to current file
            if dbloc == "":
                dbloc = oldLoc
            #Else display new file
            else:
    ...
    main.addButton("Add a Transaction",press,1,0,1,1)
    main.addButton("Edit Holdings",press,2,0,1,1)
    main.addButton("Toggle Currency",press,3,0,1,1)
    main.addButton("Generate Pie Chart",press,4,0,1,1)
    main.addButton("Open different folio",press,5,0,1,1)
    main.addButton("Save",press,5,1,1,1)
    main.addButton("Quit",press,5,3,1,1)
